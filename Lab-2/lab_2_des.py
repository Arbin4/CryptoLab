def initial_permutation(text):
  """
  Performs the initial permutation on a 64-bit block of text.

  Args:
    text: A 64-bit block of text as a string of 0s and 1s.

  Returns:
    The permuted text as a string of 0s and 1s.
  """
...
def final_permutation(text):
  """
  Performs the final permutation on a 64-bit block of text.
